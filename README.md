...
by household; sign-up/invites are not built yet). Parents manage kids, missions and rewards in the parent app; the squad
goal is still inserted in the database by hand.
